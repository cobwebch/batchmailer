...
/**
 * Test case for class Tx_Batchmailer_Controller_MailController.
 *
 * @version $Id$
 ...
 */
class Tx_Batchmailer_Controller_MailControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
